...
const {registerUser,emailVerify, loginUser, forgotPassword, resetPassword, updateUserProfileById, deleteUser, getUserById } = require("../controller/userController");
const {validateRegisterUser, validateLoginUser, validateResetPassword, validateUpdateUser} = require("../validators/userValidator");
